...
async def lifespan(app: FastAPI):
    ...
    # 3. Start Telegram bot (if token configured)
    ...
    # 4. Start sentinel modules (if enabled)
    ...
    # 5. Start swarm module (if enabled)
    ...
    # 5b. Start mesh bridge (ai-mesh operator bridge)
    if os.environ.get("MESH_BRIDGE_ENABLED", "false").lower() == "true":
